...
Nightmare.prototype.createResponse = function(data) {

  var result = new Response(this);
...
function until(check, timeout, interval, then) {
  ...
  var checker = setInterval(function() {
    ...
    if (res) {
      ...
      clearInterval(checker);
      var err = new Error('Timeout limit expired');
      err.nightmare = this;
      throw err;
    }
  }.bind(this), interval);
...
Object.keys(actions).forEach(function (name) {
  Nightmare.prototype[name] = function(){
    ...
    return function(){
      return actions[name].apply(self,args)
    }
  };
});
